    ...
    html_content = f'''
        ...
        <body>
            ...
            <form action="/chat" method="post">
                <input type="text" name="user_message" placeholder="메시지를 입력" required/>
...
async def post_chat(user_message:str = Form(...)): 
    # user_message:str = Form(...) : 사용자가 form-data로 전송한 텍스트를 받는다.
...
# 용어하나만 익히기: RAG (Retrieval-Augmented Generation) - 검색증강생성
